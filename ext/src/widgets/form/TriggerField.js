...
Ext.form.TriggerField = Ext.extend(Ext.form.TextField,  {
     ...
     * <pre><code>{tag: "image", src: Ext.BLANK_IMAGE_URL, cls: "x-form-trigger " + this.triggerClass}</code></pre>
     */
    /**
    ...
    onRender : function(ct, position){
        ...
        this.trigger = this.wrap.createChild(this.triggerConfig ||
                {tag: "image", src: Ext.BLANK_IMAGE_URL, cls: "x-form-trigger " + this.triggerClass});
        if(this.hideTrigger){
...
Ext.form.TwinTriggerField = Ext.extend(Ext.form.TriggerField, {
    ...
    initComponent : function(){
        ...
        this.triggerConfig = {
            ...
            {tag: "image", src: Ext.BLANK_IMAGE_URL, cls: "x-form-trigger " + this.trigger1Class},
            {tag: "image", src: Ext.BLANK_IMAGE_URL, cls: "x-form-trigger " + this.trigger2Class}
        ]};
    },
