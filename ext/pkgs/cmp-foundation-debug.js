    ...
    setIconClass : function(cls){
        ...
        if(this.rendered && this.header){
            if(this.frame){
                ...
                var img = hd.firstChild && String(hd.firstChild.tagName).toLowerCase() == 'image' ? hd.firstChild : null;
                if(img){
                    Ext.fly(img).replaceClass(old, this.iconCls);
                }else{
                    Ext.DomHelper.insertBefore(hd.firstChild, {
                        tag:'image', src: Ext.BLANK_IMAGE_URL, cls:'x-panel-inline-icon '+this.iconCls
                    });
                 }
            }
        }
